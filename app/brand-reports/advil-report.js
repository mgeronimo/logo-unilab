    ...
    ref.once("value").then(function(snapshot) {
        ...
        snapshot.forEach(function(childSnapshot) {
            ...
            if(
                ...
                reportsTable += "<td>" + score(childSnapshot.val().advil.firstGuess, childSnapshot.hasChild('advil') ? checkUndefined(childSnapshot.val().advil.firstHints) : "0", childSnapshot.hasChild('advil') ? checkUndefined(childSnapshot.val().advil.firstSeconds) : "0") + "</td>";
