    ...
    respondent.once("value").then(function(snapshot) {
        ...
        snapshot.forEach(function(childSnapshot) {
            ...
            if(childSnapshot.hasChild('advil')) {
                ...
                score = score + childSnapshot.val().advil.firstGuess ? 1 : 0;
            }else{
                advilSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('alaxan')) {
                ...
                score = score + childSnapshot.val().alaxan.firstGuess ? 1 : 0;                
            }else{
                unilabSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('allerta')) {
                ...
                score = score + childSnapshot.val().allerta.firstGuess ? 1 : 0;
            }else{
                allertaSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('ascof')) {
                ...
                score = score + childSnapshot.val().ascof.firstGuess ? 1 : 0;
            }else{
                ascofSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('bioflu')) {
                ...
                score = score + childSnapshot.val().bioflu.firstGuess ? 1 : 0;
            }else{
                biofluSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('biogesic')) {
                ...
                score = score + childSnapshot.val().biogesic.firstGuess ? 1 : 0;
            }else{
                biogesicSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('celeteque')) {
                ...
                score = score + childSnapshot.val().celeteque.firstGuess ? 1 : 0;
            }else{
            ...
            if(childSnapshot.hasChild('centrum')) {
                ...
                score = score + childSnapshot.val().centrum.firstGuess ? 1 : 0;
            }else{
                centrumSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('cetaphil')) {
                ...
                score = score + childSnapshot.val().cetaphil.firstGuess ? 1 : 0;
            }else{
                cetaphilSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('conzace')) {
                ...
                score = score + childSnapshot.val().conzace.firstGuess ? 1 : 0;
            }else{
                conzaceSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('decolgen')) {
                ...
                score = score + childSnapshot.val().decolgen.firstGuess ? 1 : 0;
            }else{
                decolgenSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('diatabs')) {
                ...
                score = score + childSnapshot.val().diatabs.firstGuess ? 1 : 0;
            }else{
                diatabsSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('efficascent')) {
                ...
                score = score + childSnapshot.val().efficascent.firstGuess ? 1 : 0;
            }else{
            ...
            if(childSnapshot.hasChild('enervon')) {
                ...
                score = score + childSnapshot.val().enervon.firstGuess ? 1 : 0;
            }else{
                enervonSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('gatorade')) {
                ...
                score = score + childSnapshot.val().gatorade.firstGuess ? 1 : 0;
            }else{
                gatoradeSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('gynepro')) {
                ...
                score = score + childSnapshot.val().gynepro.firstGuess ? 1 : 0;
            }else{
                gyneproSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('kremils')) {
                ...
                score = score + childSnapshot.val().kremils.firstGuess ? 1 : 0;
            }else{
                kremilsSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('lactacyd')) {
                ...
                score = score + childSnapshot.val().lactacyd.firstGuess ? 1 : 0;
            }else{
                lactacydSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('mcdo')) {
                ...
                score = score + childSnapshot.val().mcdo.firstGuess ? 1 : 0;
            }else{
                mcdoSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('myra')) {
                ...
                score = score + childSnapshot.val().myra.firstGuess ? 1 : 0;
            }else{
                myraSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('neozep')) {
                ...
                score = score + childSnapshot.val().neozep.firstGuess ? 1 : 0;
            }else{
                neozepSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('phcare')) {
                ...
                score = score + childSnapshot.val().phcare.firstGuess ? 1 : 0;
            }else{
                phcareSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('rexidol')) {
                ...
                score = score + childSnapshot.val().rexidol.firstGuess ? 1 : 0;
            }else{
                rexidolSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('ritemed')) {
                ...
                score = score + childSnapshot.val().ritemed.firstGuess ? 1 : 0;
            }else{
                ritemedSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('robitussin')) {
                ...
                score = score + childSnapshot.val().robitussin.firstGuess ? 1 : 0;
            }else{
            ...
            if(childSnapshot.hasChild('skelan')) {
                ...
                score = score + childSnapshot.val().skelan.firstGuess ? 1 : 0;
            }else{
                skelanSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('solmux')) {
                ...
                score = score + childSnapshot.val().solmux.firstGuess ? 1 : 0;
            }else{
                solmuxSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('tgp')) {
                ...
                score = score + childSnapshot.val().tgp.firstGuess ? 1 : 0;
            }else{
                tgpSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('uhp')) {
                ...
                score = score + childSnapshot.val().uhp.firstGuess ? 1 : 0;
            }else{
                uhpSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('unilab')) {
                ...
                score = score + childSnapshot.val().unilab.firstGuess ? 1 : 0;
            }else{
                unilabSkipCounter++;
            }
            ...
            if(childSnapshot.hasChild('vicks')) { 
                ...
                score = score + childSnapshot.val().vicks.firstGuess ? 1 : 0;
            } else {
                vicksSkipCounter++;
            }
